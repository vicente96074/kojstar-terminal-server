package com.kojstarinnovations.terminal.shared.security.config;
...
/**
 * SecurityService - Class that provides the security service.
 * Every method in this class is used to validate if the user has access or role.
 */
