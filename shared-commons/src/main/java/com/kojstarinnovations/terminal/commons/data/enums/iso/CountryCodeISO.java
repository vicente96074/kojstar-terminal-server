...
public enum CountryCodeISO {
    ...
    CountryCodeISO(String code, String name) {
        this.code = code;
        this.name = name;
    }

    public static Optional<CountryCodeISO> fromCode(String code) {
    ...
    private static final Map<String, CountryCodeISO> CODE_MAP =
