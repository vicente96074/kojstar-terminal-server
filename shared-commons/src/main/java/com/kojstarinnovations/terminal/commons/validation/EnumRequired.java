...
import com.kojstarinnovations.terminal.commons.validators.EnumRequiredValidator;
...
/**
 * EnumRequired - Annotation to validate if a field is required
 *
 * @Author: Kojstar Innovations (Augusto Vicente)
 */
@Documented
@Constraint(validatedBy = EnumRequiredValidator.class)
